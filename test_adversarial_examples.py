...
def visualize_results(G, batch_size, images):
    ...
    utils.save_images(samples[:image_frame_dim * image_frame_dim, :, :, :], [image_frame_dim, image_frame_dim],
                      'H:/pytorch-generative-model-collections/results/cifar10/DRAGAN_adv' + '.png')
...
pretrained_generator_path = 'H:/pytorch-generative-model-collections/models/cifar10/DRAGAN_adv/DRAGAN_adv_G_best.pkl'
pretrained_G = DRAGAN_adv.generator(
    input_dim=2352, output_dim=3, input_size=28).to(device)
...
cifar10_dataset = torchvision.datasets.CIFAR10(
    'H:/cifar-10-batches-py', train=True, transform=transform, download=True)
...
cifar10_dataset_test = torchvision.datasets.CIFAR10(
    'H:/cifar-10-batches-py', train=False, transform=transform, download=True)
