...
class WGAN_GP(object):
    def __init__(self, args):
        ...
        if not (os.path.join(self.save_dir, self.dataset, self.model_name,self.model_name)):
            os.mkdir(os.path.join(self.save_dir, self.dataset, self.model_name,self.model_name))
